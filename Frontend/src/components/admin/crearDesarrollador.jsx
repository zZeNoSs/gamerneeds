...
const CrearDesarrollador = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Desarrollador creado exitosamente');
    ...
    <div className="p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        ...
        <div>
          <textarea
            name="descripcion"
            placeholder="Descripción del desarrollador (mínimo 20 caracteres)"
        ...
        <div className="flex gap-4 mt-8 pt-6 border-t border-gray-700">
          <button
            ...
            {loading ? 'Creando...' : 'Crear Desarrollador'}</button>
          <button
            type="button"
